      ...
      <div className="grid gap-6 sm:grid-cols-1">
        ...
        <div>
          ...
          <Select
            ...
            className={errors.parent_id ? 'border-red-500 focus-visible:ring-red-500' : ''}
          ...
          {errors.parent_id && (
            <p className="mt-1.5 text-sm font-medium text-red-600">{errors.parent_id.message}</p>
          )}
        ...
        <div>
          ...
          />
          {errors.slug && (
            <p className="mt-1.5 text-sm font-medium text-red-600">{errors.slug.message}</p>
          )}
          {slugValue && !errors.slug && (
            <div className="mt-2 rounded-lg border border-blue-200 bg-blue-50/50 px-3 py-2">
              <p className="text-xs font-medium text-blue-900 mb-1">Preview da URL:</p>
          ...
          <div className="mt-1.5 flex items-center justify-between">
            ...
            {slugValue && (
              <p className={`text-xs ${errors.slug ? 'text-red-600' : 'text-gray-400'}`}>
